...
"%</a> ");e='<span class="date" style="background-color: #EEE;"></span>';if(!a.disable&&"General"!=g&&void 0!=a.details.plannedCompletionDate)if(d=a.details.plannedCompletionDate,d=new Date(Date.parse(d)),console.re.log("444"),console.re.log(d),console.re.log(Date.parse(d)),console.re.log(a.details.plannedCompletionDate.replace(/:\d\d\d/,"")),console.re.log(!isNaN(d.getTime())),isNaN(d.getTime()))b.attr("data-days",9999);else{var h=new Date;h.setHours(0);h.setMinutes(0);h.setSeconds(0);e="#D2E0FF";
