...
var attask = function () {
    ...
    function X(a, b) {
        ...
        void (0 == e || "" == e) && !g.get("apiKey") ? v(a) : (n.show(), e = {url: t() + "user/" + g.get("userID"), data: {method: "put", updates: "{isActive: true}"}, type: "get", dataType: "json"}, w(e), e = jQuery.ajax(e), e.done(function (e) {
