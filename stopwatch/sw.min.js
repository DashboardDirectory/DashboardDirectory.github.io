...
c,b){x({response:a.responseText,type:c,msg:b},qa,"addRecentTasks")})}function ra(){function a(a){var h={url:t()+"assgn/search?"+a+":statusEquatesWith=NEW&"+a+":statusEquatesWith=INP&"+a+":statusEquatesWith=ROP&project:statusEquatesWith=CUR&project:statusEquatesWith=QUE&status=AA&status=AD",type:"get",data:{},dataType:"json"};h.data[a+":statusEquatesWith_Mod"]="in";h.data[a+":isComplete"]=!1;h.data.status_Mod="in";h.data["project:statusEquatesWith_Mod"]="in";h.data["project:projectedCompletionDate"]=
"$$TODAYb-1w";h.data["project:projectedCompletionDate_Mod"]="gt";h.data.assignedToID=f.get("userID");h.data.fields=a+":parent,"+a+":priority,"+a+":project, "+a+":project:hourTypes,"+a+":project:status,"+a+":status, "+a+":extRefID,"+a+":permissions,"+a+":plannedCompletionDate";"task"==a&&(h.data.fields+=",task:percentComplete");w(h);return h}n.show();jQuery.when(jQuery.ajax(a("task")),jQuery.ajax(a("opTask"))).done(function(a,h){a=a[0];h=h[0];var b=void 0!=a.error?a.error:h.error;void 0!=b?(b["class"]==
y[0]?v(function(){ra()}):e(s[0],"addCurrentTasks,"+JSON.stringify(b)),n.hide(),q.hide()):0==a.data.length&&0==h.data.length?(A=!0,D(function(){TASK_CNTRL.showAll()})):D(function(){function b(a,c){for(var h=a.length,e=0;e<h;e++){var k=a[e],k=k[c];TASK_DB.insert(k.name,{syncID:k.ID,details:k},e==h-1)}}A=!0;b(a.data,"task");b(h.data,"opTask")})}).fail(function(a,b,e){x({response:a.responseText,type:b,msg:e},function(){ra()},"addCurrentTasks")})}function sa(){function a(a){var b={url:t()+"assgn/search?"+
a+":statusEquatesWith=NEW&"+a+":statusEquatesWith=INP&"+a+":statusEquatesWith=ROP&project:statusEquatesWith=CUR&project:statusEquatesWith=QUE",type:"get",data:{},dataType:"json"};b.data[a+":statusEquatesWith_Mod"]="in";b.data[a+":isComplete"]=!1;b.data[a+":canStart"]=!0;b.data.status="AA";b.data["project:statusEquatesWith_Mod"]="in";b.data["project:projectedCompletionDate"]="$$TODAYb-1w";b.data["project:projectedCompletionDate_Mod"]="gt";b.data.assignedToID=f.get("userID");b.data.fields=a+":parent,"+
a+":priority,"+a+":project, "+a+":project:hourTypes,"+a+":project:status,"+a+":status, "+a+":extRefID,"+a+":permissions,"+a+":plannedCompletionDate";"task"==a&&(b.data.fields+=",task:percentComplete");w(b);return b}n.show();jQuery.when(jQuery.ajax(a("task")),jQuery.ajax(a("opTask"))).done(function(a,b){a=a[0];b=b[0];var k=void 0!=a.error?a.error:b.error;void 0!=k?(k["class"]==y[0]?v(function(){sa()}):e(s[0],"addRequestedTasks,"+JSON.stringify(k)),n.hide(),q.hide()):0==a.data.length&&0==b.data.length?
(A=!0,D(function(){TASK_CNTRL.showAll()})):D(function(){function e(a,c){for(var b=a.length,h=0;h<b;h++){var k=a[h][c];TASK_DB.insert(k.name,{syncID:k.ID,details:k},h==b-1)}}A=!0;e(a.data,"task");e(b.data,"opTask")})}).fail(function(a,b,e){x({response:a.responseText,type:b,msg:e},function(){sa()},"addRequestedTasks")})}function ta(){function a(a){var b={url:t()+"assgn/search?"+a+":statusEquatesWith=ONH&"+a+":statusEquatesWith=AWF&project:statusEquatesWith=CUR&project:statusEquatesWith=QUE&project:statusEquatesWith=ONH&project:statusEquatesWith=PLN",
type:"get",data:{},dataType:"json"};b.data[a+":statusEquatesWith_Mod"]="in";b.data[a+":isComplete"]=!1;b.data.status="AD";b.data["project:statusEquatesWith_Mod"]="in";b.data["project:projectedCompletionDate"]="$$TODAYb-1w";b.data["project:projectedCompletionDate_Mod"]="gt";b.data.assignedToID=f.get("userID");b.data.fields=a+":parent,"+a+":priority,"+a+":project, "+a+":project:hourTypes,"+a+":project:status,"+a+":status, "+a+":extRefID,"+a+":permissions,"+a+":plannedCompletionDate";"task"==a&&(b.data.fields+=
",task:percentComplete");w(b);return b}n.show();jQuery.when(jQuery.ajax(a("task")),jQuery.ajax(a("opTask"))).done(function(a,b){a=a[0];b=b[0];var k=void 0!=a.error?a.error:b.error;void 0!=k?(k["class"]==y[0]?v(function(){ta()}):e(s[0],"addOnHoldTasks,"+JSON.stringify(k)),n.hide(),q.hide()):0==a.data.length&&0==b.data.length?(A=!0,D(function(){TASK_CNTRL.showAll()})):D(function(){function e(a,c){for(var b=a.length,h=0;h<b;h++){var k=a[h],k=k[c];TASK_DB.insert(k.name,{syncID:k.ID,details:k},h==b-1)}}
A=!0;e(a.data,"task");e(b.data,"opTask")})}).fail(function(a,b,e){x({response:a.responseText,type:b,msg:e},function(){ta()},"addOnHoldTasks")})}function Ha(){var a={url:t()+"user/search",data:{"hourTypes:isActive":!0,fields:"hourTypes:ID,hourTypes:name,hourTypes:description,hourTypes:countAsRevenue",ID:f.get("userID")},type:"get",dataType:"json"};w(a);ua=!1;a=jQuery.ajax(a);a.done(function(a){if(void 0!=a.error)a.error["class"]==y[0]?v(function(){}):e(s[0],"getHourTypes,"+JSON.stringify(a.error)),
n.hide(),q.hide();else if(a=a.data,void 0!=a&&0!=a.length&&0!=a[0].hourTypes.length){f.set("hour_type_list",a[0].hourTypes);for(var b=[],k=0;k<a[0].hourTypes.length;k++)b[a[0].hourTypes[k].ID]=!0;f.set("hour_types",b);ua=!0}});a.fail(function(a,b,k){401==a.status?v(function(){}):"timeout"==b?Ha():e(s[0],"getHourTypes,"+a.responseText)})}function Ra(a,c){if("GEN"==a.details.objCode)c(a);else{var b=f.get("hour_type_list");if(b&&1==b.length)a.details.hourTypeID=b[0].ID,TASK_DB.updateDetails(a.ID,a.details),
c(a);else if(a.details.project.hourTypes&&1==a.details.project.hourTypes.length)a.details.hourTypeID=a.details.project.hourTypes[0].ID,TASK_DB.updateDetails(a.ID,a.details),c(a);else{var e=jQuery("#hourTypeSelector");e.text("");b&&b.length&&jQuery.each(b,function(){var a=this.ID;e.append($("<option />").val(a).text(this.name))});a.details.project.hourTypes&&a.details.project.hourTypes.length&&jQuery.each(a.details.project.hourTypes,function(){e.append($("<option />").val(this.ID).text(this.name))});
TASK_CNTRL.showWindow(null,"#hourTypeWindow");jQuery("#done_hourType").unbind("click").bind("click",function(b){b.preventDefault();a.details.hourTypeID=jQuery("#hourTypeSelector").find(":selected").val();TASK_DB.updateDetails(a.ID,a.details);c(a);TASK_CNTRL.hideWindow("#hourTypeWindow")});jQuery("#cancel_hourType").unbind("click").bind("click",function(a){a.preventDefault();TASK_CNTRL.hideWindow("#hourTypeWindow")})}}}function da(a){var c=f.get("todaySched");null!=c?a(c):(c={url:t("api/v7.0")+"user/search?ID=$$USER.ID&fields=schedule:*,schedule:nonWorkDays:*",
type:"get",data:{},dataType:"json"},w(c),c=jQuery.ajax(c),c.done(function(c){if(void 0!=c.error)c.error["class"]==y[0]?v(function(){}):e(s[0],"getSchedule,"+JSON.stringify(c.error)),n.hide(),q.hide();else if(c=c.data[0].schedule,0!=c.length){var b=new Date,m=c["sunday monday tuesday wednesday thursday friday saturday".split(" ")[b.getDay()]],d;if(!0==c.hasNonWorkDays){for(var g=0;g<c.nonWorkDays.length;g++)if(c.nonWorkDays[g].nonWorkDate==b.getFullYear()+"-"+(b.getMonth()+1)+"-"+b.getDate()&&(void 0!=
d&&null!=c.nonWorkDays[g].userID||void 0==d))d=c.nonWorkDays[g].scheduleDay;void 0!=d&&(m=d)}void 0!=m&&0!=m.length&&(m={start:m[0],stop:m[1]},f.set("todaySched",m));a&&a(m)}}),c.fail(function(c,b,f){401==c.status?v(function(){}):"timeout"==b?da(a):e(s[0],"getSchedule,"+c.responseText)}))}function la(){var a=new Date,a={url:t()+"hour/report?hours_AggFunc=sum",type:"get",data:{entryDate:a.getFullYear()+"-"+(a.getMonth()+1)+"-"+a.getDate(),ownerID:f.get("userID")},dataType:"json"};w(a);a=jQuery.ajax(a);
a.done(function(a){void 0!=a.error?(a.error["class"]==y[0]?v(function(){}):e(s[0],"getTodaysTotalHours,"+JSON.stringify(a.error)),n.hide(),q.hide()):(a=a.data,jQuery("#totalHours").html("Today's Hours: "+(null==a.sum_hours?"0":a.sum_hours.toFixed(2))))});a.fail(function(a,b,k){401==a.status?v(function(){}):"timeout"==b?la():e(s[0],"getTodaysTotalHours,"+a.responseText)})}function U(a){n.show();var c={assignedToID:f.get("userID")};"OPTASK"==a.details.objCode?c.opTaskID=a.syncID:c.taskID=a.syncID;c=
{url:t()+"assignment/search",type:"get",data:c,dataType:"json"};w(c);c=jQuery.ajax(c);c.done(function(c){void 0!=c.error?(c.error["class"]==y[0]?v(function(){U(a)}):e(s[0],"getTaskAssignment,"+a.syncID+","+JSON.stringify(c.error)),n.hide(),q.hide()):(c=c.data[0],a.running?(a.done=1,TASK_CNTRL.stopTask(a)):va(c,a))});c.fail(function(c,b,e){x({response:c.responseText,type:b,msg:e},function(){U(a)},"getTaskAssignment,"+a.syncID)})}function va(a,c){n.show();var b={url:t()+"assignment/"+a.ID,data:{method:"PUT",
status:"DN"},type:"get",dataType:"json"};w(b);b=jQuery.ajax(b);b.done(function(b){void 0!=b.error?(b.error["class"]==y[0]?v(function(){va(a,c)}):e(s[0],"setAssignmentDone,"+a.ID+","+JSON.stringify(b.error)),n.hide(),q.hide()):(TASK_DB.remove(c.ID),n.hide(),q.hide(),e(s[2],F(c)+",assignment done"),e(s[1],"assignment done"),wa(c))});b.fail(function(b,e,h){x({response:b.responseText,type:e,msg:h},function(){va(a,c)},"setAssignmentDone,"+a.ID+", "+b.responseText)})}function wa(a){n.show();var c={url:t()+
"assignment/count",data:{status:"DN",status_Mod:"ne"},type:"GET",dataType:"json"};"OPTASK"==a.details.objCode?c.data.opTaskID=a.syncID:c.data.taskID=a.syncID;w(c);c=jQuery.ajax(c);c.done(function(c){void 0!=c.error?(c.error["class"]==y[0]?v(function(){wa(a)}):e(s[0],"getTaskDoneAssignmentCount,"+taskID+","+JSON.stringify(c.error)),n.hide(),q.hide()):(c=c.data,n.hide(),q.hide(),0==c.count&&Z(a))});c.fail(function(c,b,e){x({response:c.responseText,type:b,msg:e},function(){wa(a)},"getTaskDoneAssignmentCount,"+
a.syncID)})}function Z(a){var c=a.syncID;n.show();var b="OPTASK"==a.details.objCode?"CLS":"CPL",b={url:t()+a.details.objCode.toLowerCase()+"/"+c,data:{method:"put",status:b},type:"get",dataType:"json"};w(b);b=jQuery.ajax(b);b.done(function(b){void 0!=b.error?(b.error["class"]==y[0]?v(function(){Z(a)}):x({response:b.error,type:null,msg:null},function(){Z(a)},"setTaskDone,"+c),n.hide(),q.hide()):(n.hide(),q.hide(),e(s[2],F(a)+",task done"),e(s[1],"task done"))});b.fail(function(b,e,h){x({response:b.responseText,
type:e,msg:h},function(){Z(a)},"setTaskDone,"+c+", "+b.responseText)})}function P(a){n.show();var c={url:t()+a.details.objCode.toLowerCase()+"/"+a.syncID,data:{status:"INP",method:"PUT"},type:"get",dataType:"json"};w(c);c=jQuery.ajax(c);c.done(function(c){void 0!=c.error?(c.error["class"]==y[0]?v(function(){P(a)}):x({response:c.error,type:null,msg:null},function(){P(a)},"setTaskInProgress,"+a.syncID),n.hide(),q.hide()):(n.hide(),q.hide(),!0==f.get("logout_on_select")&&J())});c.fail(function(c,b,e){x({response:c.responseText,
type:b,msg:e},function(){P(a)},"setTaskInProgress-fail,"+a.syncID+", "+c.responseText)})}function W(a,c,b){n.show();b={url:t()+"note/",data:{auditType:"NO",ownerID:f.get("userID"),objID:a.syncID,noteObjCode:a.details.objCode,noteText:c.substring(0,2E3),auditText:"Stopwatch",isPrivate:b,method:"post"},type:"get",dataType:"json"};w(b);b=jQuery.ajax(b);b.done(function(b){void 0!=b.error&&(b.error["class"]==y[0]?v(function(){W(a,c)}):x({response:b.error,type:null,msg:null},function(){W(a,c)},"setComment,"+
a.syncID));n.hide();q.hide()});b.fail(function(b,e,h){x({response:b.responseText,type:e,msg:h},function(){W(a,c)},"setComment-fail,"+a.syncID+", "+b.responseText)})}function V(a,c){n.show();var b={url:t()+a.details.objCode.toLowerCase()+"/"+a.syncID,data:{updates:"{ percentComplete: "+c+"}",method:"PUT"},type:"get",dataType:"json"};w(b);b=jQuery.ajax(b);b.done(function(b){void 0!=b.error?b.error["class"]==y[0]?v(function(){V(a,c)}):x({response:b.error,type:null,msg:null},function(){V(a,c)},"setTaskPercent,"+
a.syncID):(a.details.percentComplete=c,TASK_DB.updateDetails(a.ID,a.details));n.hide();q.hide()});b.fail(function(b,e,h){x({response:b.responseText,type:e,msg:h},function(){V(a,c)},"setTaskPercent-fail,"+a.syncID+", "+b.responseText)})}function Oa(a,c,b){var k,m={ownerID:f.get("userID")};void 0==c||-1!=c.permissions.actions.indexOf("ADD_HOURS")&&-1!=c.permissions.actions.indexOf("CHANGE_STATUS")?(k=0,m.method="post"):(k=c.hours,m.method="put",m.ID=c.ID);"GEN"==a.details.objCode?m.hourTypeID=a.syncID:
("OPTASK"==a.details.objCode?m.opTaskID=a.syncID:m.taskID=a.syncID,m.hourTypeID=f.get("forceHourTypeID"),void 0==m.hourTypeID&&(void 0!=a.details.hourTypeID&&""!=a.details.hourTypeID)&&(m.hourTypeID=a.details.hourTypeID));isNaN(k)&&(k=0);m.entryDate=a.dateStr;var d=Number((a.duration/3600).toFixed(2));f.get("nearestHour")&&(d=Math.round(d));m.hours=parseFloat((d+parseFloat((""+k).split(".").join("."))+" ").split(".").join(".")).toFixed(2);m.ownerID=f.get("userID");var g=new Date;b||(m.extRefID=("OK~"+
g.getHours()+":"+g.getMinutes()+"H"+m.hours+"D"+d+"T"+TASK_CNTRL.hms(a.time)+";"+(c&&c.extRefID?c.extRefID.replace("OK~","OK!"):".")).substring(0,254));e(s[1],"setHourAttask, oldhr: "+k+" method: "+m.method+" start: "+a.dateStr+" task: "+JSON.stringify(a)+" sid: "+f.get("sessionID")+" time: "+g.toTimeString());var p=function(){n.show();var c={url:t()+"hour/",type:"get",data:m,dataType:"json",async:!1};w(c);c=jQuery.ajax(c);c.done(function(c){void 0!=c.error?(c.error["class"]==y[0]?v(function(){p()}):
x({response:c.error,type:null,msg:null},p,"setHourAttask,"+a.syncID+" "+a.name+" url: "+t()+" "+JSON.stringify(m)+" "+F(a)+","+a.duration,'Time was not tracked, please click on "View" for task: '+a.name+" to record time manually."),n.hide(),q.hide()):(TASK_DB.setTask(a),TASK_CNTRL.toggleRunText(),la(),void 0!=m.taskID||void 0!=m.opTaskID?P(a):!0==f.get("logout_on_select")&&J(),n.hide(),q.hide(),e(s[2],F(a)),e(s[1],"time tracked newHr: "+m.hours+" "+a.duration+" oldHr: "+k),a.done&&U(a))});c.fail(function(c,
b,e){x({response:c.responseText,type:b,msg:e},p,"setHourAttask-fail,"+a.syncID+" "+a.name+" url: "+t()+" "+JSON.stringify(m)+" "+F(a)+","+a.duration+", "+c.responseText+", "+e,c.responseText+'<br>Time was not tracked, please click on "View" for task: '+a.name+" to record time manually.")})};p()}function La(a,c){X(a,function(a,b,e){c(a,b)},!1)}function Ma(a,c,b){var e={method:"put",ID:c,description:b.substring(0,2E3)};"GEN"==a.details.objCode?e.hourTypeID=a.syncID:"OPTASK"==a.details.objCode?e.opTaskID=
a.syncID:e.taskID=a.syncID;var f=function(){n.show();var c={url:t()+"hour/",type:"get",data:e,dataType:"json",async:!1};w(c);c=jQuery.ajax(c);c.done(function(c){n.hide();q.hide();void 0!=c.error&&(c.error["class"]==y[0]?v(function(){f()}):x({response:c.error,type:null,msg:null},f,"setHourNoteAttask,"+a.syncID+" "+a.name+" url: "+t()+" "+JSON.stringify(e)+" "+F(a)+","+a.duration,"Timesheet hour note was not recorded."))});c.fail(function(c,b,h){x({response:c.responseText,type:b,msg:h},f,"setHourNoteAttask-fail,"+
a.syncID+" "+a.name+" url: "+t()+" "+JSON.stringify(e)+" "+F(a)+","+a.duration+", "+c.responseText+", "+h,c.responseText+"<br>Timesheet hour note was not recorded.")})};f()}function X(a,c,b){var k=new Date,d={};d.entryDate=void 0!=a.dateStr?a.dateStr:k.getFullYear()+"-"+(k.getMonth()+1)+"-"+k.getDate();d.fields="permissions,ID,hours,extRefID,description";d.ownerID=f.get("userID");"GEN"==a.details.objCode?d.hourTypeID=a.syncID:("OPTASK"==a.details.objCode?d.opTaskID=a.syncID:d.taskID=a.syncID,void 0!=
a.details.hourTypeID&&""!=a.details.hourTypeID&&(d.hourTypeID=a.details.hourTypeID));k={url:t()+"hour/search",type:"get",data:d,dataType:"json",async:!1};w(k);k=jQuery.ajax(k);k.done(function(f){if(void 0!=f.error)f.error["class"]==y[0]?v(function(){X(a,c,b)}):e(s[0],"getHour,"+a.syncID+","+JSON.stringify(f.error)),n.hide(),q.hide();else if(e(s[1],"getHour "+f.data.length+" "+JSON.stringify(f.data)),c){for(var k=f.data.length,d=0;d<k;d++)if(-1!=f.data[d].permissions.actions.indexOf("ADD_HOURS")&&
-1!=f.data[d].permissions.actions.indexOf("CHANGE_STATUS")){c(a,f.data[d],b);return}c(a,f.data[0],b)}});k.fail(function(c,b,h){e(s[0],"getHour,"+a.syncID+","+JSON.stringify(h))})}var y=["com.attask.common.AuthenticationException"],s=["error","debug","informational"],f,I=!(window.hasOwnProperty("chrome")&&window.chrome.hasOwnProperty("windows")),E=isMobile(),ca="www.atappstore.com",xa="secure.atappstore.com",Fa=-1!==document.URL.indexOf("dashboard.directory")||-1!==document.URL.indexOf(ca)||-1!==document.URL.indexOf(xa),
ua=!1,L=!1,Pa="Force Desktop Stopwatch Access",ya=300,H=[],C=[],za,Aa,K={current:{f:ra,t:"Current",d:"Tasks and issues you're working on"},recent:{f:qa,t:"Recent",d:"All tasks and issues tracked within 14 days"},requested:{f:sa,t:"Requested",d:"Tasks and issues you can start on"},onhold:{f:ta,t:"On Hold",d:"Tasks and issues that are on hold"},all:{f:R,t:"All Assigned",d:"All tasks and issues assigned to you"},team:{f:pa,t:"Team Assigned",d:"All tasks and issues assigned to your Teams"},role:{f:oa,
t:"Role Assigned",d:"All tasks and issues available to your Roles"}};I&&(!Fa&&-1==location.origin.indexOf("localhost"))&&(location="https://"+ca+"/client/enterprise-stopwatch/launch.html");z();f=I?{settings:[],set:function(a,c){switch(a){case "domain":case "host":case "userID":case "sessionID":case "username":case "date":case "view":case "current_sort":case "launched":case "ent":"object"===typeof c&&(c=JSON.stringify(c)),this.setCookie(a,c,9999999999)}this.settings[a]=c},get:function(a){switch(a){case "domain":case "host":case "userID":case "sessionID":case "username":case "date":case "view":case "current_sort":case "launched":case "ent":var c=
...
f.get("todaySched"),g=f.get("minuteBuffer"),p=k.toLocaleDateString("en-US"),l=Date.parse(p+d.start),d=Date.parse(p+d.stop),p=new Date(l);b<l&&b>p.setMinutes(p.getMinutes()-g)&&(b=new Date(l));p=new Date(d);k>d&&k<p.setMinutes(p.getMinutes()+g)&&(k=new Date(d));if(b>=k){n.hide();return}c=Math.floor((k.getTime()-b.getTime())/1E3);e(s[1],"minuteBufferSnapToSched: "+b+" == "+k+" dur:"+c)}0==c||0==Number((c/3600).toFixed(2))?(n.hide(),TASK_DB.setTask(a)):("GEN"==a.details.objCode&&jQuery("#item"+a.ID).find(".hour-note").show(),
M(a,c,!1))});OB.update.add(function(a,c){q.show();M(a,c,!1)});OB.start.add(function(a){ka(a)});OB.preStart.add(function(a){a.running?TASK_CNTRL.toggleTimer(a):navigator.onLine&&!a.disable&&(p(a,a.time)||function(){TASK_DB.loadAll(function(c){var b,e,d=!1,g=c.length;for(b=0;b<g;b++)if(e=c[b],null!=e&&e.running&&a.ID!=e.ID){TASK_CNTRL.toggleTimer(e);d=!0;break}ua||a.details.project&&a.details.project.hourTypes&&a.details.project.hourTypes.length?Ra(a,function(a){TASK_CNTRL.toggleTimer(a)}):(TASK_CNTRL.toggleTimer(a),
!d&&!0==f.get("logout_on_select")&&J())})}())});OB.postAllItemRender.add(function(){jQuery(".remove").css("display","none");jQuery(".update").css("display","none");jQuery(".reset").css("display","none");f.get("is_auth")?jQuery("#storelink").text("AtAppStore"):(jQuery("#sort-date").remove(),jQuery(".timer").remove(),jQuery(".done").remove(),jQuery(".percent").remove(),jQuery(".btn-comment").remove(),jQuery(".date").removeClass("date").addClass("date-tall").html('<a href="http://store.atappstore.com/index.php/portfolio/stopwatch/" target="_blank">Trial Expired</a>'),
jQuery("#storelink").text("Trial Expired - AtAppStore"));f.get("hideTaskButtons")&&(jQuery(".timer").addClass("timer-tall"),jQuery(".done").remove(),jQuery(".percent").remove(),jQuery(".task").remove(),jQuery(".view").remove(),jQuery(".date").remove(),jQuery(".btn-comment").remove(),jQuery("#sort-date").remove());f.get("ent")&&jQuery("#totalHours").attr("title","").attr("data-hasqtip",!1).unbind("click").addClass("disabled");if(A){var a=jQuery("#form-list"),c=f.get("vpos");void 0!=c&&a.scrollTop(c);
"team"==f.get("view")&&!0==f.get("hide_team_done")&&jQuery(".done").remove();L?f.get("allowOffline")&&(jQuery(".done").remove(),jQuery(".percent").remove(),jQuery(".view").remove(),jQuery("#bar").hide()):jQuery("#bar").show();c=f.get("current_sort");void 0!=c?("string"===typeof c&&(c=JSON.parse(c)),C[c.sort]=c.order,c=c.sort):(c=f.get("sort"),void 0==c&&(c="date"));jQuery("#sort-"+c).click();jQuery("#search-bar").is(":visible")&&jQuery("#search").click();jQuery("#loading").hide();a.show();a=jQuery("#holder")[0];
a.style.display="none";a.style.display="block";n.hide();A=!1}});OB.postItemRender.add(function(a){var c=jQuery("#item"+a.ID),b=c.find(".details");if(0==c.find("#buttons .view").length){var e=c.find("#buttons"),d=["",{label:"Low",css:"default"},{label:"Normal",css:"success"},{label:"High",css:"warning"},{label:"Urgent",css:"danger"}];"GEN"!=a.details.objCode&&(void 0!=a.details.priority&&0!=a.details.priority)&&(d=d[a.details.priority],e.append('<span class="task priority '+d.css+'" title="'+d.label+
'" data-priority="'+a.details.priority+'">'+d.label[0]+"</span> "));var g;"GEN"==a.details.objCode?(g="General",c.attr("data-type",g),c.attr("data-force-order",0),e.attr("class","days priority"),c.attr("class","item general")):"OPTASK"==a.details.objCode?(g="Issue",c.attr("data-type",g),c.attr("data-force-order",1),e.append('<span class="issue" title="Issue">I</span> ')):"TASK"==a.details.objCode&&(g="Task",c.attr("data-type",g),c.attr("data-force-order",1),e.append('<span class="task" title="Task">T</span> '));
void 0!=a.details.status&&(b.attr("data-status",a.details.status),e.append('<span class="status" title="'+g+" status: "+a.details.status+"<br>Project status: "+a.details.project.status+'">'+a.details.status+"</span> "));"General"!=g&&(e.append('<a href="https://'+f.get("host")+"."+f.get("domain")+"/"+g.toLowerCase()+"/view?ID="+a.syncID+'" target="_blank" class="btn btn-mini view" rel="'+a.ID+'" title="View '+g+'"><i class="fas fa-tasks"></i></a> '),a.disable?void 0!=a.details.status&&(c.find(".timer").text("status: "+
a.details.status).unbind("click").addClass("disabled"),c.find(".timer-info").text("status: "+a.details.status)):e.append('<a href="#" class="btn btn-mini done" rel="'+a.ID+'" title="Done '+g+'"><i class="fas fa-check"></i></a> '));"General"!=g&&e.append('<a href="#" class="btn btn-mini btn-comment" rel="'+a.ID+'" title="Add Comment"><i class="fas fa-comment-dots"></i></a> ');!a.disable&&("Task"==g&&void 0!=a.details.percentComplete)&&e.append('<a href="#" class="btn btn-mini percent" rel="'+a.ID+
'" title="Percent Completed">'+a.details.percentComplete+"%</a> ");e='<span class="date" style="background-color: #EEE;"></span>';if(!a.disable&&"General"!=g&&void 0!=a.details.plannedCompletionDate)if(d=a.details.plannedCompletionDate.replace(/:\d\d\d/,"").replace(/-/g,"/").replace(/[a-z]+/gi," ").replace(/\/(\d\d\d\d)/,"-$1"),d=new Date(Date.parse(d)),isNaN(d.getTime()))b.attr("data-days",9999);else{var p=new Date;p.setHours(0);p.setMinutes(0);p.setSeconds(0);e="#D2E0FF";p=Math.round((d.getTime()-
p.getTime())/1E3/60/60/24);0>p?e="#FFCDCD":1>=p&&(e="#FFD7AB");var l;l=0<p?"days due: "+p:"days late: "+Math.abs(p);e='<div class="date" style="background-color: '+e+';"><div class="days">'+l+"</div><div>"+fa(d.getMonth())+" "+d.getDate()+", "+d.getFullYear()+"</div></div>";b.attr("data-days",p)}else b.attr("data-days",9999);d="";null!=a.details.parent&&(d="<br><br>Parent Task: <br>"+a.details.parent.name);p="";a.details.extRefID&&(p="Reference: <br>"+a.details.extRefID);c.find(".name").attr("title",
g+": <br>"+a.name+p+d);"General"!=g?(g=a.details.project.name,b.html(g).attr("title","Project: <br>"+g+"<br>Status: "+a.details.project.status).attr("data-priority",a.details.priority),b="",a.disable||(b='<span class="hour-note" rel="'+a.ID+'">Add Note</span>'),c.find(".c6").after('<div class="task-lower-block">'+e+b+"</div>")):(b.html(a.details.description).attr("title",a.details.description),b=a.time?"block":"hidden",c.find(".c6").after('<div class="general-lower-block"><span class="hour-note" style="display:'+
b+';" rel="'+a.ID+'">Add Note</span></div>'));E||c.find(".task-lower-block").mouseover(function(){var a=jQuery(this).find(".hour-note"),c=a.attr("rel");jQuery("#item"+c);if((c=TASK_DB.get(c))&&c.time&&!c.running&&!c.disable){var b=jQuery(this).find(".date").hide(),e=a.show();setTimeout(function(){b.show();e.hide()},3E3)}}).mouseout(function(){jQuery(this).find(".date").show();jQuery(this).find(".hour-note").hide()})}});OB.remove.add(function(a){jQuery("#item"+a).remove()});OB.reset.add(function(a,
