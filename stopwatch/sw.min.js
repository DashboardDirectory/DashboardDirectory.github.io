...
void 0!==n&&n()}))}}function Z(a,b,c,d,e){g.set("sessionID",a);g.set("userID",b);g.set("username",c);g.set("password",d);e=e.split(".");g.set("host",e[0]);e.shift();g.set("domain",e.join("."));g.get("allowOffline")&&g.set(c,{sessionID:a,userID:b,username:c,password:d})}function V(a){var c=g.get("sessionID");void 0==c||""==c?J(a):(x.show(),c={url:r()+"user/"+g.get("userID"),data:{updates:"{isActive: true}"},type:"PUT",dataType:"json"},z&&F(c),c=jQuery.ajax(c),c.done(function(c){void 0!=c.error?(c.error["class"]==
P[0]?J(a):(g.get("sessionID"),JSON.stringify(c.error)),x.hide(),u.hide()):(x.hide(),u.hide(),b(),!g.get("ent")&&void 0==g.get("auth_key")?e(L):L(),void 0!=a&&a())}),c.fail(function(b,c,f){401==b.status?J(a):"timeout"==c?V(a):g.get("sessionID")}))}function L(){x.show();var a=g.get("userID"),b={url:"https://"+g.get("host")+"."+g.get("domain")+"/attask/api-unsupported/timeSheet/search",type:"get",data:{startDate:"$$TODAY+1",startDate_Mod:"lte",endDate:"$$TODAY-1",endDate_Mod:"gte",fields:"timesheetProfile:hourTypes:ID,timesheetProfile:hourTypes:name,timesheetProfile:hourTypes:description,timesheetProfile:hourTypes:isActive",
userID:a},dataType:"json"};F(b,35E3);ia?g.get("allowOffline")?(a=TASK_DB.userRunningTasks(a),void 0!=a&&(v=!0,TASK_DB.insert(a.name,{syncID:a.syncID,details:a.details},!0))):TASK_CNTRL.displayError("OFFLINE"):(a=jQuery.ajax(b),a.done(function(a){if(void 0!=a.error)a.error["class"]==P[0]?J(function(){L()}):c(w[0],"addGeneralTasks-done,"+JSON.stringify(a.error));else if(a=a.data,0!=a.length&&void 0!=a[0].timesheetProfile&&void 0!=a[0].timesheetProfile.hourTypes){if(0!=a[0].timesheetProfile.hourTypes.length){var b=
0;a=a[0].timesheetProfile.hourTypes;for(var f in a)a.hasOwnProperty(f)&&!0==a[f].isActive&&(b++,TASK_DB.insert(a[f].name,{syncID:a[f].ID,details:{objCode:"GEN",description:null!=a[f].description?"General - "+a[f].description:"'General"}},0))}n();N();sa()}else ka()}),a.fail(function(a,c,m){M({response:a.responseText,type:c,msg:m,status:a.status},L,"addGeneralTasks-fail"+c+"-"+m+" "+a.responseText+" "+a.status+" "+JSON.stringify(b))}))}function ka(){x.show();var a={url:r()+"HourType/search",type:"get",
data:{fields:"ID,name,description",isActive:!0},dataType:"json"};F(a,35E3);var b=jQuery.ajax(a);b.done(function(a){if(void 0!=a.error)a.error["class"]==P[0]?J(function(){ka()}):c(w[0],"addAllGeneralTasks-done,"+JSON.stringify(a.error));else{a=a.data;var b=0,f;for(f in a)a.hasOwnProperty(f)&&("Task Time"!=a[f].name&&"Issue Time"!=a[f].name)&&(b++,TASK_DB.insert(a[f].name,{syncID:a[f].ID,details:{objCode:"GEN",description:null!=a[f].description?"General - "+a[f].description:"'General"}},0));n();N();
sa()}});b.fail(function(b,c,f){M({response:b.responseText,type:c,msg:f,status:b.status},ka,"addAllGeneralTasks-fail"+c+"-"+f+" "+b.responseText+" "+b.status+" "+JSON.stringify(a))})}function M(a,b,d,e){if(401==a.status)J(function(){b()});else if("timeout"==a.type)b();else{if(void 0!=a.response&&""!=a.response){var g;g="message"in a.response?a.response.message:JSON.stringify(a.response);TASK_CNTRL.displayError("Workfront Error: "+g+"<br>"+(void 0!=e&&""!=e?e:""))}c(w[0],d+","+a.msg+" "+a.type+" "+
JSON.stringify(a.response)+" "+e)}}function r(a){void 0==a&&(a="v7.0");return"https://"+g.get("host")+"."+g.get("domain")+"/attask/api/"+a+"/"}function y(a,b){a=void 0==a?"task":a;x.show();var d={url:r()+a+"/search",type:"get",data:{canStart:!0,status:"N",status_Mod:"contains","project:status":"CUR",fields:"parent,priority,project,plannedCompletionDate,permissions","assignments:status":"DN","assignments:status_Mod":"ne",$$LIMIT:2E3},dataType:"json"},e=g.get("currentRole");"role"==g.get("view")&&void 0!=
e?d.data.roleID=e.ID:d.data["assignments:assignedToID"]=g.get("userID");"task"==a&&(d.data.fields+=",percentComplete");F(d);d=jQuery.ajax(d);d.done(function(d){if(void 0!=d.error)d.error["class"]==P[0]?J(function(){y(a,b)}):c(w[0],"addAllAssignedTasks-"+a+","+JSON.stringify(d.error)),x.hide(),u.hide();else{d=d.data;var e=!0,q=g.get("view");"all"!=q&&"role"!=q&&(e=!1);if("optask"!=a)y("optask",b),fa(function(){var a=d.length;if(a)for(var b=0;b<a;b++)-1!=d[b].permissions.actions.indexOf("ADD_HOURS")&&
-1!=d[b].permissions.actions.indexOf("CHANGE_STATUS")&&TASK_DB.insert(d[b].name,{syncID:d[b].ID,details:d[b]},e&&b==a-1)});else{q=d.length;v=e;if(q)for(var h=0;h<q;h++)-1!=d[h].permissions.actions.indexOf("ADD_HOURS")&&-1!=d[h].permissions.actions.indexOf("CHANGE_STATUS")&&TASK_DB.insert(d[h].name,{syncID:d[h].ID,details:d[h]},e&&h==q-1);else TASK_CNTRL.showAll(d);b&&b()}}});d.fail(function(a,b,c){M({response:a.responseText,type:b,msg:c},y,"addAllAssignedTasks-fail"+b+"-"+c+" "+a.responseText)})}
function ga(a){x.show();var b={url:r("v5.0")+"user/search",type:"get",data:{fields:"role:*,roles:*",ID:g.get("userID")},dataType:"json"};F(b);b=jQuery.ajax(b);b.done(function(b){if(void 0!=b.error)b.error["class"]==P[0]?J(function(){ga(a)}):c(w[0],"addAllRoleTasks,"+JSON.stringify(b.error)),x.hide(),u.hide();else if(b=b.data[0],0==b.length)a&&a(),x.hide(),u.hide();else{var f=jQuery("#role-filter"),d=function(){y("task",function(){f.css("display","inline-block");x.hide();u.hide()})},e=function(a,b){g.set("currentRole",
{name:a,ID:b});f.find("button").html("<strong>Role: </strong><span>"+a+'</span><span class="caret"></span>');d()},h=g.get("currentRole");void 0!=h?e(h.name,h.ID):void 0!=b.role&&e(b.role.name,b.role.ID);if(void 0!=b.roles&&0!=b.roles.length)for(var h=f.find(".dropdown-menu").html("").first(),n=0,k=b.roles.length;n<k;n++)h.append('<li><a href="#" id="'+b.roles[n].ID+'">'+b.roles[n].name+"</a></li>"),h.find("#"+b.roles[n].ID).click(function(){e(jQuery(this).text(),jQuery(this).attr("id"))});else ba(),
x.hide(),u.hide(),jQuery("#button-current").click(),TASK_CNTRL.showWindow('<h3><div style="text-align: center; font-weight: bold;">Roles</div></h3><div class="content"><div><p>No additional roles available.</strong></h3><div><a href="#" class="btn btn-primary cancel" title="Ok">Ok</a><div>')}});b.fail(function(a,b,c){M({response:a.responseText,type:b,msg:c},ga,"addAllRoleTasks")})}function ba(){var a=jQuery("#role-filter");a.hide();a.find(".dropdown-menu").first().html("")}function pa(a){x.show();
var b={url:r()+"team/search",type:"get",data:{fields:"ID","users:ID":g.get("userID")},dataType:"json"};F(b);b=jQuery.ajax(b);b.done(function(b){void 0!=b.error?(b.error["class"]==P[0]?J(function(){pa(a)}):c(w[0],"addAllGroupTasks,"+JSON.stringify(b.error)),x.hide(),u.hide()):(b=b.data,0==b.length?(a?a():jQuery("#form-list").hide(),x.hide(),u.hide(),TASK_CNTRL.showNoTaskWindow()):fa(function(){for(var c=b.length,f=function(b,f){if(0==--c){var d=I.length;v=!0;if(0==d)TASK_CNTRL.showAll(I);else{for(var e=
0;e<d;e++)TASK_DB.insert(I[e].name,{syncID:I[e].ID,details:I[e]},e==d-1);I=[];a&&a()}}},d=0;d<c;d++)qa("task",b[d].ID,f)}))});b.fail(function(a,b,c){M({response:a.responseText,type:b,msg:c},pa,"addAllGroupTasks")})}function qa(a,b,d){a=void 0==a?"task":a;x.show();var e={url:r()+a+"/search?project:status=INF",type:"get",data:{canStart:!0,status:"N",status_Mod:"contains","project:status":"CUR",fields:"parent,priority,project,plannedCompletionDate",$$LIMIT:1E3,"team:ID":b},dataType:"json"};"task"==a&&
(e.data.fields+=",percentComplete");F(e);e=jQuery.ajax(e);e.done(function(e){if(void 0!=e.error)e.error["class"]==P[0]?J(function(){qa(a,b,d)}):c(w[0],"addGroupTasks-"+a+","+JSON.stringify(e.error)),x.hide(),u.hide();else if(e=e.data,0==e.length)d&&d(a,b);else if("optask"!=a){qa("optask",b,d);for(var g=e.length,h=0;h<g;h++)I.push(e[h])}else{g=e.length;for(h=0;h<g;h++)I.push(e[h]);d&&d(a,b)}});e.fail(function(a,b,c){M({response:a.responseText,type:b,msg:c},qa,"addGroupTasks-fail"+b+"-"+c+" "+a.responseText)})}
function ha(){x.show();var a={url:r()+"hour/report",type:"get",data:{"task:canStart":!0,taskID_1_GroupBy:!0,entryDate:"$$TODAY-14d",entryDate_Range:"$$TODAY",entryDate_Mod:"between"},dataType:"json"};F(a);a=jQuery.ajax(a);a.done(function(a){void 0!=a.error?(a.error["class"]==P[0]?J(function(){ha()}):c(w[0],"addRecentTasks,"+JSON.stringify(a.error)),x.hide(),u.hide()):(a=Object.keys(a.data),0==a.length?(v=!0,fa(function(){TASK_CNTRL.showAll(a)})):fa(function(){v=!0;TASK_CNTRL.showAll(TASK_CNTRL.taskDB.loadSyncIds(a))}))});
a.fail(function(a,b,c){M({response:a.responseText,type:b,msg:c},ha,"addRecentTasks")})}function ra(){x.show();var a={url:r()+"work/myWork",type:"get",data:{fields:"parent,priority,project,plannedCompletionDate"},dataType:"json"};F(a);a=jQuery.ajax(a);a.done(function(a){void 0!=a.error?(a.error["class"]==P[0]?J(function(){ra()}):c(w[0],"addCurrentTasks,"+JSON.stringify(a.error)),x.hide(),u.hide()):(a=a.data,0==a.length?(v=!0,fa(function(){TASK_CNTRL.showAll(a)})):fa(function(){var b=a.length;v=!0;
for(var c=0;c<b;c++)TASK_DB.insert(a[c].name,{syncID:a[c].ID,details:a[c]},c==b-1)}))});a.fail(function(a,b,c){M({response:a.responseText,type:b,msg:c},ra,"addCurrentTasks")})}function ja(){x.show();var a={url:r()+"work/workRequests",type:"get",data:{canStart:!0,fields:"parent,priority,project,plannedCompletionDate"},dataType:"json"};F(a);a=jQuery.ajax(a);a.done(function(a){void 0!=a.error?(a.error["class"]==P[0]?J(function(){ja()}):c(w[0],"addRequestedTasks,"+JSON.stringify(a.error)),x.hide(),u.hide()):
(a=a.data,0==a.length?(v=!0,fa(function(){TASK_CNTRL.showAll(a)})):fa(function(){var b=a.length;v=!0;for(var c=0;c<b;c++)TASK_DB.insert(a[c].name,{syncID:a[c].ID,details:a[c]},c==b-1)}))});a.fail(function(a,b,c){M({response:a.responseText,type:b,msg:c},ja,"addRequestedTasks")})}function sa(){var a={url:r()+"user/search",data:{"hourTypes:isActive":!0,fields:"hourTypes:ID,hourTypes:name,hourTypes:description,hourTypes:countAsRevenue",ID:g.get("userID")},type:"get",dataType:"json"};F(a);k=!1;a=jQuery.ajax(a);
a.done(function(a){if(void 0!=a.error)a.error["class"]==P[0]?J(function(){}):c(w[0],"getHourTypes,"+JSON.stringify(a.error)),x.hide(),u.hide();else if(a=a.data,void 0!=a&&0!=a.length&&0!=a[0].hourTypes.length){k=!0;var b=jQuery("#hourTypeSelector");b.text("");b.append(jQuery("<option />").val(null).text("Task Time"));jQuery.each(a[0].hourTypes,function(){b.append($("<option />").val(this.ID).text(this.name))})}});a.fail(function(a,b,c){401==a.status?J(function(){}):"timeout"==b&&sa()})}function la(a,
b){TASK_CNTRL.showWindow(null,"#hourTypeWindow");jQuery("#done_hourType").unbind("click").bind("click",function(c){c.preventDefault();a.hourTypeID=jQuery("#hourTypeSelector").find(":selected").val();b(a);TASK_CNTRL.hideWindow("#hourTypeWindow")})}function oa(a){var b=g.get("todaySched");null!=b?a(b):(b={url:r("v4.0")+"user/search?ID=$$USER.ID&fields=schedule:*,schedule:nonWorkDays:*",type:"get",data:{},dataType:"json"},F(b),b=jQuery.ajax(b),b.done(function(b){if(void 0!=b.error)b.error["class"]==
P[0]?J(function(){}):c(w[0],"getSchedule,"+JSON.stringify(b.error)),x.hide(),u.hide();else if(b=b.data[0].schedule,0!=b.length){var d=new Date,f=b["sunday monday tuesday wednesday thursday friday saturday".split(" ")[d.getDay()]],e;if(!0==b.hasNonWorkDays){for(var h=0;h<b.nonWorkDays.length;h++)if(b.nonWorkDays[h].nonWorkDate==d.getFullYear()+"-"+(d.getMonth()+1)+"-"+d.getDate()&&(void 0!=e&&null!=b.nonWorkDays[h].userID||void 0==e))e=b.nonWorkDays[h].scheduleDay;void 0!=e&&(f=e)}void 0!=f&&0!=f.length&&
(f={start:f[0],stop:f[1]},g.set("todaySched",f));a&&a(f)}}),b.fail(function(b,c,d){401==b.status?J(function(){}):"timeout"==c&&oa(a)}))}function N(){var a=new Date,a={url:r()+"hour/report?hours_AggFunc=sum",type:"get",data:{entryDate:a.getFullYear()+"-"+(a.getMonth()+1)+"-"+a.getDate(),ownerID:g.get("userID")},dataType:"json"};F(a);a=jQuery.ajax(a);a.done(function(a){void 0!=a.error?(a.error["class"]==P[0]?J(function(){}):c(w[0],"getTodaysTotalHours,"+JSON.stringify(a.error)),x.hide(),u.hide()):(a=
a.data,jQuery("#totalHours").html("Today's Hours: "+(null==a.sum_hours?"0":a.sum_hours.toFixed(2))))});a.fail(function(a,b,c){401==a.status?J(function(){}):"timeout"==b&&N()})}function s(a){x.show();var b={assignedToID:g.get("userID")};"OPTASK"==a.details.objCode?b.opTaskID=a.syncID:b.taskID=a.syncID;b={url:r()+"assignment/search",type:"get",data:b,dataType:"json"};F(b);b=jQuery.ajax(b);b.done(function(b){void 0!=b.error?(b.error["class"]==P[0]?J(function(){s(a)}):c(w[0],"getTaskAssignment,"+a.syncID+
","+JSON.stringify(b.error)),x.hide(),u.hide()):(b=b.data[0],a.running?(a.done=1,TASK_CNTRL.stopTask(a),TASK_CNTRL.toggleRunText()):ea(b,a))});b.fail(function(b,c,d){M({response:b.responseText,type:c,msg:d},function(){s(a)},"getTaskAssignment,"+a.syncID)})}function ea(a,b){x.show();var d={url:r()+"assignment/"+a.ID,data:{status:"DN"},type:"PUT",dataType:"json"};z&&(d.data={method:"put"},F(d));d=jQuery.ajax(d);d.done(function(d){void 0!=d.error?(d.error["class"]==P[0]?J(function(){ea(a,b)}):c(w[0],
"setAssignmentDone,"+a.ID+","+JSON.stringify(d.error)),x.hide(),u.hide()):(TASK_DB.remove(b.ID),x.hide(),u.hide(),c(w[2],da(b)+",assignment done"),D(b))});d.fail(function(c,d,e){M({response:c.responseText,type:d,msg:e},function(){ea(a,b)},"setAssignmentDone,"+a.ID+", "+c.responseText)})}function D(a){x.show();var b={url:r()+"assignment/count",data:{status:"DN",status_Mod:"ne"},type:"GET",dataType:"json"};"OPTASK"==a.details.objCode?b.data.opTaskID=a.syncID:b.data.taskID=a.syncID;F(b);b=jQuery.ajax(b);
...
a.dateStr;var h=Number((a.duration/3600).toFixed(2));g.get("nearestHour")&&(h=Math.round(h));e.hours=parseFloat((h+parseFloat((""+d).split(".").join("."))+" ").split(".").join("."));e.ownerID=g.get("userID");c(w[1],"setHourAttask, oldhr: "+d+" method: "+e.method+" start: "+a.dateStr+" task: "+JSON.stringify(a)+" sid: "+g.get("sessionID")+" time: "+(new Date).toTimeString());var n=function(){x.show();var b={url:r("v5.0")+"hour/",type:"get",data:e,dataType:"json"};F(b);b=jQuery.ajax(b);b.done(function(b){void 0!=
b.error?(b.error["class"]==P[0]?J(function(){n()}):(M({response:b.error,type:null,msg:null},n,"setHourAttask,"+a.syncID+" "+a.name+" url: "+r()+" "+JSON.stringify(e)+" "+da(a)+","+a.duration,'Time was not tracked, please click on "View" for task: '+a.name+" to record time manually."),E(a)),x.hide(),u.hide()):(N(),void 0!=e.taskID||void 0!=e.opTaskID?G(a):!0==g.get("logout_on_select")&&S(),x.hide(),u.hide(),c(w[2],da(a)),a.done&&s(a))});b.fail(function(b,c,d){M({response:b.responseText,type:c,msg:d},
n,"setHourAttask-fail,"+a.syncID+" "+a.name+" url: "+r()+" "+JSON.stringify(e)+" "+da(a)+","+a.duration+", "+b.responseText+", "+d,b.responseText+'<br>Time was not tracked, please click on "View" for task: '+a.name+" to record time manually.");E(a)})};n()}function E(a,b){var d={};d.entryDate=a.dateStr;d.fields="permissions,ID,hours";d.ownerID=g.get("userID");"GEN"==a.details.objCode?(d.hourTypeID=a.syncID,d.projectID=null,d.taskID=null,d.opTaskID=null):("OPTASK"==a.details.objCode?d.opTaskID=a.syncID:
d.taskID=a.syncID,void 0!=a.hourTypeID&&""!=a.hourTypeID&&(d.hourTypeID=a.hourTypeID));d={url:r()+"hour/search",type:"get",data:d,dataType:"json"};F(d);d=jQuery.ajax(d);d.done(function(d){if(void 0!=d.error)d.error["class"]==P[0]?J(function(){E(a,b)}):c(w[0],"getHour,"+a.syncID+","+JSON.stringify(d.error)),x.hide(),u.hide();else if(c(w[1],"getHour "+d.data.length+" "+JSON.stringify(d.data)),b){for(var e=d.data.length,g=0;g<e;g++)if(-1!=d.data[g].permissions.actions.indexOf("ADD_HOURS")&&-1!=d.data[g].permissions.actions.indexOf("CHANGE_STATUS")){b(a,
d.data[g]);return}b(a,d.data[0])}});d.fail(function(a,b,c){JSON.stringify(c)})}var P=["com.attask.common.AuthenticationException"],w=["error","debug","informational"],g,z=!(window.hasOwnProperty("chrome")&&window.chrome.hasOwnProperty("windows")),A=-1===document.URL.indexOf("http://")&&-1===document.URL.indexOf("https://")&&z,T=-1!==document.URL.indexOf("dashboard.directory"),k=!1,ia=!1,I=[];g=!z||A?new Store("Attask"):{settings:[],set:function(a,b){switch(a){case "domain":case "host":case "userID":case "sessionID":case "username":case "date":case "view":this.setCookie(a,
