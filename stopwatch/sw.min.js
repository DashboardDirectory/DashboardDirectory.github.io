...
void 0!==n&&n()}))}}function Z(a,b,c,d,e){g.set("sessionID",a);g.set("userID",b);g.set("username",c);g.set("password",d);e=e.split(".");g.set("host",e[0]);e.shift();g.set("domain",e.join("."));g.get("allowOffline")&&g.set(c,{sessionID:a,userID:b,username:c,password:d})}function V(a){var c=g.get("sessionID");void 0==c||""==c?J(a):(x.show(),c={url:r()+"user/"+g.get("userID"),data:{updates:"{isActive: true}"},type:"PUT",dataType:"json"},z&&(c.type="GET",c.data.method="PUT",F(c)),c=jQuery.ajax(c),c.done(function(c){void 0!=
c.error?(c.error["class"]==P[0]?J(a):(g.get("sessionID"),JSON.stringify(c.error)),x.hide(),u.hide()):(x.hide(),u.hide(),b(),!g.get("ent")&&void 0==g.get("auth_key")?e(L):L(),void 0!=a&&a())}),c.fail(function(b,c,f){401==b.status?J(a):"timeout"==c?V(a):g.get("sessionID")}))}function L(){x.show();var a=g.get("userID"),b={url:"https://"+g.get("host")+"."+g.get("domain")+"/attask/api-internal/timeSheet/search",type:"get",data:{startDate:"$$TODAY+1",startDate_Mod:"lte",endDate:"$$TODAY-1",endDate_Mod:"gte",
